<template>
  <Transition name="success-slide">
    <div v-if="visible" class="success-toast" @click="close">
      <div class="success-content">
        ...
        <button class="success-close" @click.stop="close">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M18 6L6 18M6 6L18 18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
          </svg>
        </button>
      </div>
      <div class="success-progress" :style="{ animationDuration: duration + 'ms' }"></div>
    </div>
  </Transition>
</template>
...
.success-slide-leave-active {
  animation: successSlideOut 0.3s cubic-bezier(0.16, 1, 0.3, 1);
}
